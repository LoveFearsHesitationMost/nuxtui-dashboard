...
const STATISTICS = [
  ...
  {
    label: "Merged Proposals",
    value: "1103",
    icon: "i-ph-git-pull-request-fill"
  },
...
<template>
  <AppLayout :show-search="false">
      ...
      <template #body>
        <div class="-mt-8 flex w-full flex-col items-center gap-2">
          ...
          <div class="flex gap-1">
            ...
            >
              <UButton color="neutral" variant="ghost" class="text-dimmed"
                >Hot word</UButton
              >
              <UButton color="neutral" variant="ghost" class="text-dimmed"
                >Word++</UButton
    ...
    <div class="-mt-8 md:-mt-16 md:flex">
      <div class="grid grid-cols-4 md:grid-cols-2">
        <UPageCard
          ...
          :ui="{
            ...
            title:
              'tabular-nums text-4xl font-bold tracking-tight leading-none',
            description:
              'font-mono uppercase text-xs tracking-[0.06em] text-dimmed mt-3',
    ...
    <div class="mt-8 not-md:px-4">
      <div class="mb-4 flex items-center gap-2">
        ...
        <UButton variant="link" class="text-base"> View All </UButton>
      </div>
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <UPageCard
          v-for="page in TRENDING_PAGES"
          :title="page.title"
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 not-md:px-4 md:grid-cols-2">
      <div>
        ...
        <div class="flex flex-col gap-1">
          <UPageList>
            <div
              ...
              :key="cat.name"
              :class="[
                'hover:bg-elevated py-2 transition-colors',
                idx !== CATEGORIES.length - 1 && 'border-b-muted border-b'
              ]"
            >
              ...
              <div class="flex flex-wrap gap-2 pl-8">
                <ULink
                  ...
                  class="text-muted hover:text-primary text-xs"
                >
                  {{ page }}
                </ULink>
              </div>

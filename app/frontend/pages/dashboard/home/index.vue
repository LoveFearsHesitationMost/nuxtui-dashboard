            ...
            <UCard>
              <div class="flex items-center justify-between">
                ...
                <div class="rounded-lg bg-green-100 p-3">
                  <UIcon name="i-lucide-star" class="h-6 w-6 text-green-600" />
                </div>
              </div>
            </UCard>
            ...
            <UCard>
              <div class="flex items-center justify-between">
                ...
                <div class="rounded-lg bg-purple-100 p-3">
                  <UIcon name="i-lucide-book" class="h-6 w-6 text-purple-600" />
                </div>
              </div>
            </UCard>
                  ...
                  >
                    <div class="flex-shrink-0">
                      <div class="rounded-lg bg-gray-100 p-2">
                        <UIcon :name="getTypeIcon(plan.type)" class="h-5 w-5" />
                      </div>
                    </div>
          ...
          <UCard>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              <UCard v-for="course in recommendedCourses" :key="course.id" class="overflow-hidden">
                ...
                <h4 class="mb-2 font-semibold">{{ course.title }}</h4>
